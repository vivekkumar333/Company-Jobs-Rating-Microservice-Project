package com.learnwithtiwari.userservice.response;
...
public class JobsResponseDTO {
	 private String jobTitle;
		...
		public JobsResponseDTO(String jobTitle, String skillSet, String description, String minSalary, String maxSalary,
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			JobsResponseDTO other = (JobsResponseDTO) obj;
			if (company == null) {
